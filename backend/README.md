...
## Project Structure
    ...
    ├── testapiautoconnect_127804  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_127804`
...
2. Clone this repo and `cd testapiautoconnect_127804`
